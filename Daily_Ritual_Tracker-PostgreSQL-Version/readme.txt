...
DRT is a minimalist, multi-user ritual tracking web app built with **Flask**, **Jinja2**, and **PostgreSQL**. It was designed with a strict philosophy: every component must do *one thing and one thing only*. No bloat, no shortcuts—just clean architecture and intentional flow.
...
1. Clone the repo  
   ```bash
   git clone https://github.com/aymen27k/Daily_Ritual_Tracker-PostgreSQL-Version.git
   cd drt
